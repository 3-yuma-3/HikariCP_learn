...
- [Index](#index)
- [Artifacts](#artifacts)
- [:checkered\_flag: JMH Benchmarks](#checkered_flag-jmh-benchmarks)
- [:microscope: Analyses](#microscope-analyses)
  ...
  - ["Imitation Is The Sincerest Form Of Plagiarism" - anonymous](#imitation-is-the-sincerest-form-of-plagiarism---anonymous)
- [:family: User Testimonials](#family-user-testimonials)
- [:gear: Configuration (knobs, baby!)](#gear-configuration-knobs-baby)
  - [Essentials](#essentials)
  - [Frequently used](#frequently-used)
  - [Infrequently used](#infrequently-used)
  - [Missing Knobs](#missing-knobs)
  - [Statement Cache](#statement-cache)
  - [Log Statement Text / Slow Query Logging](#log-statement-text--slow-query-logging)
  - [Rapid Recovery](#rapid-recovery)
- [:rocket: Initialization](#rocket-initialization)
- [Performance Tips](#performance-tips)
- [Popular DataSource Class Names](#popular-datasource-class-names)
- [Play Framework Plugin](#play-framework-plugin)
- [Clojure Wrapper](#clojure-wrapper)
- [JRuby Wrapper](#jruby-wrapper)
- [Support 💬](#support-)
- [Wiki](#wiki)
